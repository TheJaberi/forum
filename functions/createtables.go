...
func CreateTables() {
	...
	interactionTable, err7 := Database.Prepare("CREATE TABLE IF NOT EXISTS Interaction (id INTEGER PRIMARY KEY, post_id INTEGER NOT NULL, user_id INTEGER NOT NULL, interaction BOOL)")
